...
public class DataGenerator {
  ...
  public static User generateAdminUser(int nbNotes) {
    ...
    admin.setCompleteName("Jeremy Buget");
  ...
  public static List<User> generateUsers(int rowsNumber) {
    ...
    for (int i = 0; i < rowsNumber; i++) {
      ...
      user.setCompleteName(generateRandomString(true));
  ...
  public static List<Note> generateNotes(int rowsNumber) {
    ...
    for (int i = 0; i < rowsNumber; i++) {
      Note note = new Note();
      note.setId(generateRandomString(true));
  ...
  protected static char[] goodAlphaNumChar = {
      ...
      'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C',
  ...
  protected static char[] goodChar = {
      ...
      // use String toUpper() on the user's input before validating.
      'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C',
      'D', 'E', 'F', 'G', 'H', 'J', 'K', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', '1', '2', '3', '4', '5', '6',
      '7', '8', '9', ' ', '.', ',', ';', '?', ':', '!', };
